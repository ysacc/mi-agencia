...
/**
 * Botón flotante de WhatsApp del sitio principal.
 * Es un enlace real: solo abre WhatsApp tras el click del usuario.
 */
const WhatsAppFab: React.FC = () => {
  ...
  return (
    <a
      ...
      aria-label="Escribir por WhatsApp a BR Digital System"
      onClick={() =>
        trackWhatsAppClick({
          page: "/",
          location: "boton_flotante",
    ...
    >
      ...
      <span className="wa-fab-text">Escríbenos por WhatsApp</span>
    </a>
  );
};
